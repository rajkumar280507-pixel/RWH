  ...
  return (
    <AnimatePresence>
      ...
      <motion.div
        ...
        className="glass-panel z-50 w-72 rounded-xl border border-slate-700 p-4 text-xs shadow-2xl"
        style={style}
      ...
      >
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-start gap-1.5">
            <BookOpen size={13} className="mt-0.5 shrink-0 text-accent" />
            <h4 className="text-[12.5px] font-semibold leading-snug text-slate-100">{spec.title}</h4>
          </div>
          <button
            onClick={onClose}
        ...
        <p className="mt-2 text-[10px] font-medium uppercase tracking-wide text-accent/90">{spec.standard}</p>
        ...
        <p className="mt-2.5 leading-relaxed text-slate-400">{spec.purpose}</p>

        <div className="mt-2.5 border-t border-slate-800 pt-2">
          <span className="text-[10px] font-semibold uppercase tracking-wide text-slate-500">Maintenance</span>
          <p className="mt-0.5 leading-relaxed text-slate-400">{spec.maintenance}</p>
        </div>
      </motion.div>
    </AnimatePresence>
  );
