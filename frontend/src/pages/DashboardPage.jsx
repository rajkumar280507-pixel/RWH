...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      {/* Decision-support recommendation + live sync status */}
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
        ...
        >
          <div className="flex items-center justify-between rounded-t-xl border border-b-0 border-slate-800 bg-panel/70 px-4 py-2 text-xs dark:bg-panel/70">
        ...
        <motion.div
          ...
          className="glass-panel flex flex-col gap-4 rounded-xl border border-slate-800 bg-panel/60 p-4 dark:bg-panel/60"
        >
